...
const BottomBar = ({ skip }: BottomBarProps) => {
  ...
  return (
    <div
      className="fixed bottom-0 left-0 w-full px-4 py-3 md:px-6 md:py-4 flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0 z-50 shadow-lg transition-colors duration-300"
      style={{
    ...
    >
      <div className="w-full md:w-auto text-center md:text-left">
        ...
        <p className="text-xs opacity-70">
          Imagery and information may not reflect exact size/spec. Options may
          vary.
        </p>
      </div>
      <button
